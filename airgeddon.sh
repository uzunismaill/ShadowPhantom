...
function print_custom_banner() {
	echo -e "${green_color}"
	echo "  ____  _   _    _    ____   _____        __  ____  _   _    _    _   _ _____ ___  __  __ "
	echo " / ___|| | | |  / \  |  _ \ / _ \ \      / / |  _ \| | | |  / \  | \ | |_   _/ _ \|  \/  |"
	echo " \___ \| |_| | / _ \ | | | | | | \ \ /\ / /  | |_) | |_| | / _ \ |  \| | | || | | | |\/| |"
	echo "  ___) |  _  |/ ___ \| |_| | |_| |\ V  V /   |  __/|  _  |/ ___ \| |\  | | || |_| | |  | |"
	echo " |____/|_| |_/_/   \_\____/ \___/  \_/\_/    |_|   |_| |_/_/   \_\_| \_| |_| \___/|_|  |_|"
	echo -e "${normal_color}"
	echo -e "${red_color}      SHADOW-PHANTOM SECURITY SUITE © 2025${normal_color}"
	echo -e "${blue_color}       GHOST PROTOCOL INITIATED...${normal_color}"
	echo
}
